...
export class PredicteSecretStorage {
    ...
    async getApiKey(): Promise<string | undefined> {
        try {
            const apiKey = await this.secretStorage.get(PredicteSecretStorage.API_KEY_KEY);
            ...
            throw new SecretStorageError('Failed to retrieve API key from secret storage', error);
        }
    }
    ...
    async setApiKey(apiKey: string): Promise<void> {
        ...
        try {
            ...
            throw new SecretStorageError('Failed to store API key in secret storage', error);
        }
    }
    ...
    async deleteApiKey(): Promise<void> {
        try {
            ...
            throw new SecretStorageError('Failed to delete API key from secret storage', error);
        }
    }
